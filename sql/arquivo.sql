...
CREATE TABLE public.recipes (
    ...
    information text,
    created_at timestamp without time zone DEFAULT '2020-11-17 13:48:52.477186'::timestamp without time zone NOT NULL,
    chef_id integer,
    updated_at timestamp without time zone DEFAULT '2020-11-17 13:48:43.442351'::timestamp without time zone NOT NULL,
    user_id integer
);
